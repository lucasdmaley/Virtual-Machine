...
/* driver functions */
static inline UM initialize_UM();
static inline void checkCommandline(int argc, char** argv);
static inline void load_mem(char *argv, UM um);
static inline void execute_instr(UM um);
